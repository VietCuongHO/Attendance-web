...
@section('content')
    ...
    <div id="content" class="container" style="padding-bottom: 20px">
        <div class="row"  id="employee-info">
            ...
            <div class="col-4">
                <img style="max-width: 100%; height: auto;" src="{{ $detail[0]->avatar }}" alt="avatar-{{ $detail[0]->first_name . $detail[0]->last_name }}">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <img style="max-width: 100%; height: auto;" src="{{ asset('storage/image-checkin/') . '/' . $detail[0]->image_url }}" alt="image-recogination-{{ $detail[0]->first_name . $detail[0]->last_name }}">
            </div>
        </div>
